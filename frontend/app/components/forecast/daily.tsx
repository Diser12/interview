                            ...
                            <Drawer
                                ...
                                main={
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="text-sm">{day.Day.PrecipitationProbability}%</div>
                                    </div>
                                }
                                expandedContent={
                                    <>
                            ...
                            <Drawer
                                ...
                                main={
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="text-sm">{day.Night.PrecipitationProbability}%</div>
                                    </div>
                                }
                                expandedContent={
                                    <>
                                        ...
                                        <div className="w-1/4 flex flex-col space-y-4">
                                            ...
                                            <KeyValueItem label="Moon Phase" value={day.Moon.Phase} />
                                        </div>
                                    </>
                                }
                            />
